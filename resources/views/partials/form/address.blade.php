...
<div class="row">
    ...
    <div class="col-sm-3 col-xs-5">
        <div class="form-group {{ $errors->has($addressField . '.state_id') ? 'has-error' : '' }}">
            <select class="form-control" style="width: 100%;select:invalid { color: gray; }" name="{{ $addressField }}[state_id]" id="{{ $addressField }}-state"{{ $addressSettings[$addressField]['required'] ? ' required' : '' }}>
